import { g as gotoBlock, u as uniqArray, b as bodyUnlock, a as getHash } from "./common.min.js";
(function polyfill() {
...
document.addEventListener("formSent", function(e) {
  ...
  const successMessage = document.querySelector(".connect__success");
...
window.addEventListener("scroll", () => {
  if (!isAnimating && window.pageYOffset < 5) {
    isTriggered = false;
  }
});
